...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Danh sách mẹo</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li><a class="parent-item" href="#">Mẹo</a><i class="fa fa-angle-right"></i></li>
            <li class="active">Danh sách mẹo</li>
        </ol>
    </div>
</div>
                        ...
                        <tbody>
                            @foreach ($tip as $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="valigntop">
                                        <div class="btn-group">
                                            <a href="{{ route('tip.edit', $item->id) }}">
                                                <button class="btn btn-primary btn-sm rounded-0">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                            </a>
                                            <form action="{{ route('tip.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
